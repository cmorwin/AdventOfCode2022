# Challenge Goal: Simulate crane operator moving boxes based on "First In"
# First Out
#
#
import support
...
def main():
    ...
    for i in instructions:
        ...
        # Here we need to do some fancier operations than plain pop() & append()
        for o in range(num, 0, -1):
            current_stack[dst].append(current_stack[src].pop(-o))
